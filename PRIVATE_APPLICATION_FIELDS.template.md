...
- If a form asks for full SSN, full government ID, passport number, bank details, payment, or suspicious identity collection beyond normal ATS identity verification, mark the role `Blocked - ATS` or `Blocked - CAPTCHA/security` as appropriate and continue.
